...
describe("NPI", function () {
    describe("Query (POST /npi)", function () {
        ...
        it("NPI post is not implimented ", function () {
            return expect(query({})).to.be.an.api.error(501, "not_implimented_error");
        });
    ...
    describe("Get Data (GET /npi/:npi)", function () {
        ...
        it("NPI get is no longer implimented", function () {
          return expect(query({})).to.be.an.api.error(501, "not_implimented_error");
        });
      });
  });
...
// Implimitaiton has been removed due to issues with the npi js library
// describe("NPI", function () {
//     describe("Query (POST /npi)", function () {
//         // basic endpoint
//         var query = function (data) {
