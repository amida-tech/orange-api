...
patients.get("/:patientid/avatar(.\\w+)?", authenticate, authorize("read"), function (req, res, next) {
...
patients.post("/:patientid/avatar(.\\w+)?", authenticate, authorize("write"), function (req, res, next) {
