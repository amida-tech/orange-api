...
var keys = module.exports.keys = ["firstName", "lastName", "relation", "primaryPhone", "secondaryPhone", "email"];
...
emergencyContacts.post("/", guard(["admin", "programAdministrator", "clinician", "user"]), auth.authorize("write"), filterInput, function (req, res, next) {
...
emergencyContacts.get("/:emergencyContactId", guard(["admin", "programAdministrator", "clinician", "user"]), auth.authorize("read"), function (req, res, next) {
...
emergencyContacts.delete("/:emergencyContactId", guard(["admin", "programAdministrator", "clinician", "user"]), auth.authorize("write"), function (req, res, next) {
...
emergencyContacts.put("/:emergencyContactId", guard(["admin", "programAdministrator", "clinician", "user"]), auth.authorize("write"), filterInput, function (req, res, next) {
...
emergencyContacts.get("/", guard(["admin", "programAdministrator", "clinician", "user"]), auth.authorize("read"), paramParser, function (req, res, next) {
