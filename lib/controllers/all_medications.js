...
router.get("/medications", guard(["admin", "programAdministrator", "clinician", "user"]), paramParser, function(req, res, next) {
...
router.get("/schedule", guard(["admin", "programAdministrator", "clinician", "user"]), function (req, res, next) {
