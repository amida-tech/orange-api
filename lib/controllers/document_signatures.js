...
documentSignatures.post("/", guard(["admin", "user"]), auth.authorize("write"), filterInput, function (req, res, next) {
...
documentSignatures.get("/", guard(["admin", "user"]), auth.authorize("read"), paramParser, function (req, res, next) {
