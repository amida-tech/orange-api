...
var inputKeys = ["name", "rx_norm", "ndc", "dose", "route", "form", "rx_number", "quantity", "type", "schedule",
    "doctor_id", "pharmacy_id", "doctor", "pharmacy", "fill_date"];
...
medications.get("/:medicationid", auth.authorize("read"), function (req, res, next) {
...
medications.delete("/:medicationid", auth.authorize("write"), function (req, res, next) {
...
medications.put("/:medicationid", auth.authorize("write"), filterInput, function (req, res, next) {
