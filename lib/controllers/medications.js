...
medications.get("/:medicationid/times/:timeid", guard(["admin", "clinician", "user"]), authorize("read"), function(req, res, next) {
    // find medication
    req.patient.findMedicationById(req.params.medicationid, function(err, medication) {
        if (err) return next(err);
...
medications.get("/:medicationid", guard(["admin", "clinician", "user"]), authorize("read"), function(req, res, next) {
...
medications.delete("/:medicationid", guard(["admin", "clinician", "user"]), authorize("write"), function(req, res, next) {
...
medications.put("/:medicationid", guard(["admin", "clinician", "user"]), authorize("write"), filterInput, function(req, res, next) {
...
medications.get("/", guard(["admin", "clinician", "user"]), auth.authorize("read"), paramParser, function(req, res, next) {
