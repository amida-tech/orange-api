...
router.post("/requested", guard(["admin", "programAdministrator", "clinician", "user", "instructor"]), function (req, res, next) {
...
router.delete("/requested/:requestid", guard(["admin", "programAdministrator", "clinician", "user", "instructor"]), function (req, res, next) {
    req.user.cancelRequest(req.params.requestid, returnData(res, next));
}, formatObject);

// close a request made *to* the current user
router.delete("/requests/:requestid", guard(["admin", "programAdministrator", "clinician", "user", "instructor"]), function (req, res, next) {
...
router.get("/requested", guard(["admin", "programAdministrator", "clinician", "user", "instructor"]), paramParser, statusValidator, function (req, res, next) {
...
router.get("/requests", guard(["admin", "programAdministrator", "clinician", "user", "instructor"]), paramParser, statusValidator, function (req, res, next) {
