...
router.post("/requested/bulkclinicianrequest", function (req, res, next) {
...
router.get("/requested", paramParser, statusValidator, function (req, res, next) {
...
router.get("/requests", paramParser, statusValidator, function (req, res, next) {
