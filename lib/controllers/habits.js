...
var keys = ["wake", "sleep", "breakfast", "lunch", "dinner", "tz", "access_anyone", "access_family", "access_prime"];
...
habits.get("/", auth.authorize("read"), function (req, res, next) {
...
habits.put("/", auth.authorize("write"), filterInput, function (req, res, next) {
