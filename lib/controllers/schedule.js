...
controller.get("/", function (req, res, next) {
    ...
    if (typeof end !== "string" || end.length === 0) end = moment(today).add(6, "days"); // default to one week later
    ...
    if (medicationId !== null) {
        ...
        if (typeof medication === "undefined" || medication === null) return next(errors.INVALID_RESOURCE_MEDICATION_ID);
