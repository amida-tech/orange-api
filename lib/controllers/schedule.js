...
var keys = ["type", "date", "medication_id", "took_medication", "delay", "dose_id", "happened"];

// view a patient's schedule
router.get("/", auth.authorize("read"), function (req, res, next) {
    req.patient.generateSchedule(req.query.start_date, req.query.end_date, req.user, req.query.medication_id, function (err, result) {
