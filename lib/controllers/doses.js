...
doses.post("/", guard(["admin", "programAdministrator", "clinician", "user"]), auth.authorize("write"), filterInput, function(req, res, next) {
...
doses.get("/:doseid", guard(["admin", "programAdministrator", "clinician", "user", "helpDesk"]), authorize("read"), function(req, res, next) {
...
doses.delete("/:doseid", guard(["admin", "programAdministrator", "clinician", "user"]), authorize("write"), function(req, res, next) {
...
doses.put("/:doseid", guard(["admin", "programAdministrator", "clinician", "user"]), authorize("write"), filterInput, authorizeFromData("write"), function(req, res, next) {
...
doses.get("/", guard(["admin", "programAdministrator", "clinician", "user", "helpDesk"]), auth.authorize("read"), paramParser, list.parseDateFilters, function(req, res, next) {
...
doses.get("/nonempty/first", guard(["admin", "programAdministrator", "clinician", "user", "helpDesk"]), auth.authorize("read"), paramParser, list.parseDateFilters, function(req, res, next) {
    // validate and parse filter query parameters
    var rawId = req.listParameters.filters.medication_id;
    if (rawId !== null) {
        // convert from string to int
