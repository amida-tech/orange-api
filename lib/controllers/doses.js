...
doses.get("/:doseid", auth.authorize("read"), function (req, res, next) {
...
doses.delete("/:doseid", auth.authorize("write"), function (req, res, next) {
...
doses.put("/:doseid", auth.authorize("write"), filterInput, function (req, res, next) {
