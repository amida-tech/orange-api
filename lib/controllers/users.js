...
// Get basic user info
users.get("/", authenticate, guard(["admin", "programAdministrator", "clinician", "user"]), function (req, res) {
...
// Set user info
users.put("/", authenticate, guard(["admin", "programAdministrator", "clinician", "user"]), function (req, res, next) {
...
// Delete user
users.delete("/", authenticate, guard(["admin", "programAdministrator", "clinician", "user"]), function (req, res, next) {
...
// View user avatar
users.get("/avatar(.\\w+)?", authenticate, guard(["admin", "programAdministrator", "clinician", "user"]), function (req, res, next) {
...
// set user avatar
users.post("/base64Avatar", authenticate, guard(["admin", "programAdministrator", "clinician", "user"]), function (req, res, next) {
...
// set user avatar
users.post("/avatar(.\\w+)?", authenticate, guard(["admin", "programAdministrator", "clinician", "user"]), function (req, res, next) {
    req.user.setAvatar(req, function (err) {
        if (err) return next(err);
...
users.get("/:email/avatar(.\\w+)?", authenticate, guard(["admin", "programAdministrator", "clinician", "user"]), function (req, res, next) {
