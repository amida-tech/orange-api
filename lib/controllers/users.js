...
User.find({ _id: { $type : 7 } }, function(err, users) {
    if (err) {
    ...
    // Patient.findOneAndDelete({ creator: t.email, me: true }, function(err, patient) {
    //   if (err) {
    //         console.log(err);
    //   }
    //   console.log(patient);
    ...
    // });
    console.log(t._id);
    User.update({ email: t.email }, { _id: uuid.v4 }, function(err, deletedUser) {
      if (err) {
          console.log(err);
      }
    ...
    // User.remove({ _id: t._id }, function(err) {
    // if (err) {
    //       console.log(err);
    // }
  // });
    //.findOneAndRemove({ _id: t._id }, function(err) {
//     if (err) {
//           console.log(err);
//     }
// });
