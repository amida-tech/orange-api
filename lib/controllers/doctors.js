...
doctors.post("/", guard(["admin", "programAdministrator", "clinician", "user"]), auth.authorize("write"), filterInput, function (req, res, next) {
...
doctors.get("/:doctorid", guard(["admin", "programAdministrator", "clinician", "user"]), auth.authorize("read"), function (req, res, next) {
...
doctors.delete("/:doctorid", guard(["admin", "programAdministrator", "clinician", "user"]), auth.authorize("write"), function (req, res, next) {
...
doctors.put("/:doctorid", guard(["admin", "programAdministrator", "clinician", "user"]), auth.authorize("write"), filterInput, function (req, res, next) {
...
doctors.get("/", guard(["admin", "programAdministrator", "clinician", "user"]), auth.authorize("read"), paramParser, function (req, res, next) {
