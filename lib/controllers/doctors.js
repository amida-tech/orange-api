...
doctors.post("/", guard(["admin"]), auth.authorize("write"), filterInput, function (req, res, next) {
...
doctors.get("/:doctorid", guard(["admin"]), auth.authorize("read"), function (req, res, next) {
...
doctors.delete("/:doctorid", guard(["admin"]), auth.authorize("write"), function (req, res, next) {
...
doctors.put("/:doctorid", guard(["admin"]), auth.authorize("write"), filterInput, function (req, res, next) {
...
doctors.get("/", guard(["admin", "user"]), auth.authorize("read"), paramParser, function (req, res, next) {
