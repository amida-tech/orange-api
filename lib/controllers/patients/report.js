...
var setupMedication = curry(function (data, medication) {
    ...
    if (medication.statistics !== null) {
        ...
        doc.push({
            text: util.format("Events Taken: %d (%d%)", medication.statistics.taken, medication.statistics.takenPercentage),
            style: "detailsHeader"
        });
        doc.push({
            text: util.format("Events Skipped: %d (%d%)", medication.statistics.skipped, medication.statistics.skippedPercentage),
            style: "detailsHeader"
        });
        doc.push({
            text: util.format("Events Not Recorded: %d (%d%)", medication.statistics.notRecorded, medication.statistics.notRecordedPercentage),
            style: "detailsHeader"
        });
    }
