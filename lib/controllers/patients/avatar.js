...
avatar.get("/", auth.authenticate, guard(["admin", "programAdministrator", "clinician", "user", "instructor"]), auth.authorize("read"), function (req, res, next) {
...
avatar.post("/", auth.authenticate, guard(["admin", "programAdministrator", "clinician", "user", "instructor"]), auth.authorize("write"), function (req, res, next) {
