...
var keys = module.exports.keys = inputKeys.concat(["avatar", "creator"]);
...
var paramParser = list.parseListParameters(["id", "first_name", "last_name"], ["first_name", "last_name", "group", "creator"]);
