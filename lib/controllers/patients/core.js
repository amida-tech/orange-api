...
// View single patient
patients.get("/:id", auth.authenticate, guard(["admin", "programAdministator", "clinician", "user", "instructor"]), function (req, res, next) {
...
patients.put("/:id", auth.authenticate, guard(["admin", "programAdministator", "clinician", "user", "instructor"]), filterInput, function (req, res, next) {
...
patients.delete("/:id", auth.authenticate, guard(["admin", "programAdministator", "clinician", "user"]), function (req, res, next) {
...
patients.get("/", auth.authenticate, guard(["admin", "programAdministator", "clinician", "user", "instructor"]), paramParser, function (req, res, next) {
