...
// View single patient
patients.get("/:id", auth.authenticate, guard(["admin", "programAdministator", "clinician", "user"]), function (req, res, next) {
...
patients.put("/:id", auth.authenticate, guard(["admin", "programAdministator", "clinician", "user"]), filterInput, function (req, res, next) {
...
patients.get("/", auth.authenticate, guard(["admin", "programAdministator", "clinician", "user"]), paramParser, function (req, res, next) {
