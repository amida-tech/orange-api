...
var inputKeys = ["date", "text", "medication_ids", "medications", "mood", "moodEmoji"];
...
// in medications_id
// additionally, only allow clinicians to access clinician notes, and vice versa
...
journal.get("/", auth.authorize("read"), paramParser, list.parseDateFilters, function (req, res, next) {
    ...
    const filters = Object.assign({}, req.listParameters.filters, { clinician: req.user.clinician });;
