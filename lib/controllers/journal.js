...
journal.post("/", auth.authorize("write"), filterInput, function (req, res, next) {
...
journal.get("/:journalentry", auth.authorize("read"), function (req, res, next) {
...
journal.delete("/:journalentry", auth.authorize("write"), function (req, res, next) {
...
journal.put("/:journalentry", auth.authorize("write"), filterInput, function (req, res, next) {
