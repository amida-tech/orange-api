...
var queryJournalEntries = function (meditation){
 return function (req, res, next) {
    ...
    const filters = Object.assign({}, req.listParameters.filters, clinicianParam, meditationParam);
...
journal.get("/meditations", auth.authorize("read"), paramParser, list.parseDateFilters, addMedications, queryJournalEntries(true), formatList);
...
journal.get("/", auth.authorize("read"), paramParser, list.parseDateFilters, addMedications, queryJournalEntries(false), formatList);
