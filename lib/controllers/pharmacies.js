...
pharmacies.post("/", auth.requireWrite, filterInput, function (req, res, next) {
...
pharmacies.delete("/:pharmacyid", auth.requireWrite, function (req, res, next) {
...
pharmacies.put("/:pharmacyid", auth.requireWrite, filterInput, function (req, res, next) {
