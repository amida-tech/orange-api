...
module.exports = {
    ...
    ERRORS: {
        ...
        LAST_NAME_REQUIRED: new APIError("last_name_required", 400),
        ...
        // EmergencyContacts
        INVALID_EMERGENCY_CONTACT_ID: new APIError("invalid_emergency_contact_id", 404),
        RELATION_REQUIRED: new APIError("relation_required", 400),

        // Document Signatures
        DOCUMENT_NAME_REQUIRED: new APIError("document_name_required", 400),
        VERSION_REQUIRED: new APIError("version_required", 400),
        ...
        INVALID_TIMEZONE: new APIError("invalid_timezone", 400),
        ...
        // External APIs
        NPI_ERROR: new APIError("npi_error", 500),
        NOT_IMPLIMENTED_ERROR: new APIError("not_implimented_error", 501),
