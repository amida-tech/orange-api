...
module.exports = function (UserSchema) {
    ...
    var genTextData = function (data, user, context, callback) {
        ...
        if (data.sendText === false) return callback(null, null);
    ...
    UserSchema.methods.notify = function (data, callback) {
        ...
        async.parallel({
            ...
            // if we have a phone number for the user and text data
            if (typeof user.phone !== "undefined" && user.phone !== null && user.phone.length > 0 && messages.text !== null) {
