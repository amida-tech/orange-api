...
module.exports = function (Schedule) {
    ...
    Schedule.prototype.generate = function (startExact, endExact, habits, numberTaken, userId, moreSchedules) {
        ...
        for (var j = 0; j < this.cycleStarts.length; j++) {
            ...
            /* To allow for the client to always use 0 in the exlcude array to represent the most recent sunday
                the decicion was made to split the cycleStart value into two different values (cylceStart and scheduleLoopStart). 
                ...
                the modulos of that difference. 
            */
