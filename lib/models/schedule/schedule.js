...
var Schedule = module.exports = function (data, habits) {
    ...
    // timezone
    var tz = habits.tz;
    if (typeof tz === "undefined" || tz === null) tz = "Etc/UTC";
    ...
    if (this.regularly) {
        ...
        if (typeof this.frequency !== "undefined" && this.frequency !== null && typeof this.frequency.start !== "undefined" && this.frequency.start !== null) {
