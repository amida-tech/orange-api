    ...
    Schedule.prototype.isValid = function () {
        ...
        if (this.regularly) {
            ...
            if (typeof this.frequency.start !== "undefined" && this.frequency.start !== null) {
                if (typeof this.frequency.start !== "string") return false;
            ...
            anyInvalid = this.times.some(function(item) {
                ...
                keys = Object.keys(item).filter(function (k) { return k !== "id"; });
                if (item.type === "event") {
                    ...
                    // shouldn't have any other keys apart from an optional ID
