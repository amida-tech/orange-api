...
UserSchema.methods.updateHabits = function (habits, callback) {
...
// Retrieve habits: if undefined returns blank strings
UserSchema.virtual('habits').get(function() {
    var habits = {};
    if (typeof this.wake === 'undefined') habits.wake = '';
    else habits.wake = this.wake;
    if (typeof this.sleep === 'undefined') habits.sleep = '';
    else habits.sleep = this.sleep;
    if (typeof this.breakfast === 'undefined') habits.breakfast = '';
    else habits.breakfast = this.breakfast;
    if (typeof this.lunch === 'undefined') habits.lunch = '';
    else habits.lunch = this.lunch;
    if (typeof this.dinner === 'undefined') habits.dinner = '';
    else habits.dinner = this.dinner;
    return habits;
});
