...
JournalEntrySchema.methods.setData = function (data) {
    ...
    // Filter for disallowing help desk to do anything else
    // It just empties the data object
    ...
    if (typeof data.meditationDifficulty !== "undefined") this.meditationDifficulty = data.meditationDifficulty;
    if (typeof data.meditationTaken !== "undefined") this.meditationTaken = data.meditationTaken;
    if (typeof data.meditationRequestedAssistance !== "undefined") this.meditationRequestedAssistance = data.meditationRequestedAssistance;
...
JournalEntrySchema.methods.getData = function () {
    ...
    if (typeof this.meditationDifficulty !== "undefined" && this.meditationDifficulty !== null) data.meditationDifficulty = this.meditationDifficulty;
    if (typeof this.meditationRequestedAssistance !== "undefined" && this.meditationRequestedAssistance !== null) data.meditationRequestedAssistance = this.meditationRequestedAssistance;
    ...
    if (typeof this.meditationTaken !== "undefined" && this.meditationTaken !== null) data.meditationTaken = this.meditationTaken;
