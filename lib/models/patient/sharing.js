...
module.exports = function (PatientSchema) {
    ...
    PatientSchema.methods.share = function (email, access, group, first_name, last_name, callback) {
    ...
    PatientSchema.methods.createShare = function (email, access, group, first_name, last_name, callback) {
