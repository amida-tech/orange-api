...
module.exports = function (gfs) {
    ...
    var PatientSchema = new mongoose.Schema({
        ...
        shares: [{
            ...
            access:     { type: String, enum: ["read", "write"], required: false }
        }],
        // the default access levels of the 4 different groups of shared users
        permissions: {
            anyone:     { type: String, enum: ["read", "write"], required: true, default: "read" },
            family:     { type: String, enum: ["read", "write"], required: true, default: "read" },
            prime:      { type: String, enum: ["read", "write"], required: true, default: "write" }
        },
        // habits
